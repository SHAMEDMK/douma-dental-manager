    ...
    <div className="flex items-center justify-between p-3 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <button
          ...
          className="px-3 py-1.5 text-xs bg-shamed-navy text-white rounded-md hover:bg-shamed-navy/90 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
        >
          {isAdding ? '...' : 'Ajouter'}
        </button>
      </div>
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="flex items-center gap-1 px-4 py-2 text-sm rounded-md border border-shamed-navy text-shamed-navy bg-white hover:bg-shamed-bg transition-colors"
      >
        ...
        <>
          ...
          <div className="mb-3">
            <input
              ...
              className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-shamed-copper/40 focus:border-shamed-navy"
            />
          </div>
