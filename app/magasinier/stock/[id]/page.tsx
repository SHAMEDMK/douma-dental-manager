...
export default async function MagasinierStockAdjustmentPage({
  params,
  searchParams,
}: {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">
            Ajustement de Stock – {variantDisplayName}
          </h1>
          <p className="text-gray-500 mt-1">
            Variante du produit {product.name}
          </p>
          {variant.sku && (
        ...
        <StockAdjustmentForm
          ...
          successRedirectPath="/magasinier/stock?updated=1"
        />
      </div>
    )
  }
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">
          Ajustement de Stock – {product.name}
        </h1>
        {product.sku && (
