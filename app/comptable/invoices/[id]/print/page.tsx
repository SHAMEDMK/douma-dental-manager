...
export default async function ComptableInvoicePrintPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Calculate remaining TTC (remaining = invoice.totalTTC - totalPaid, min 0)
      ...
      <div className="print:hidden sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Link
              href={`/comptable/invoices/${invoice.id}`}
        ...
        <div className="print:hidden max-w-4xl mx-auto px-4 py-4">
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
            <div className="flex items-center gap-2">
              ...
              <span className="text-red-600 text-xs">Cette facture ne peut plus être modifiée.</span>
            </div>
          </div>
        </div>
      )}
