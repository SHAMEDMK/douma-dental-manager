...
export default function ShipOrderModal({ isOpen, onClose, orderId, orderNumber }: ShipOrderModalProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      console.log('Shipping order with:', {
      ...
      const result = await markOrderShippedAction(orderId, {
        deliveryAgentName: deliveryAgentName.trim(),
        deliveryAgentId: deliveryAgentId || undefined, // Use ID if available, otherwise fallback to name
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Le livreur assigné sera notifié automatiquement
                </p>
              </div>
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                data-testid="confirm-ship-order"
