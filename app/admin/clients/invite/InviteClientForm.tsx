...
export default function InviteClientForm() {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    const result = await createInvitation({ email, name, clientCode, companyName, segment: segment as any, discountRate, creditLimit })
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        {!inviteLink ? (
          <form action={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="clientCode" className="block text-sm font-medium text-gray-700">Code client</label>
              <input
                type="text"
                name="clientCode"
                id="clientCode"
            ...
            <div>
              <label htmlFor="creditLimit" className="block text-sm font-medium text-gray-700">Plafond de crédit (Dh)</label>
              <input
                type="number"
                name="creditLimit"
                id="creditLimit"
            ...
            <div>
              ...
              <div className="flex rounded-md shadow-sm">
                ...
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-l-0 border-gray-300 rounded-r-md bg-gray-50 text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-shamed-copper/40 focus:border-shamed-navy"
                >
