...
export default function DeleteClientButton({ clientId, clientName, clientEmail }: { clientId: string; clientName: string; clientEmail: string }) {
    ...
    return (
      <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-lg">
        <p className="text-sm text-red-800 mb-3">
          Êtes-vous sûr de vouloir supprimer le client <strong>{clientName}</strong> ({clientEmail}) ? Cette action est irréversible.
        </p>
        <p className="text-xs text-red-600 mb-3">
          Note: Un client ne peut pas être supprimé s'il a des commandes existantes.
        </p>
